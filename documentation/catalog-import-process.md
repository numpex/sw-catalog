...
- `allow` : optional - specifies whether this mapping object is allowed to create new projects in `projects.json`,  to update existing ones, or both. Default value is 'update'.
