...
* [x] Packages are available in community repositories
  - https://github.com/spack/spack-packages/blob/develop/repos/spack_repo/builtin/packages/damaris/package.py
...
* [x] CI runs regularly (each new commit in main branch)
  - https://gitlab.inria.fr/Damaris/damaris/-/pipelines
...
* [x] Licence is FLOSS licence (FSF or OSI conformant)
  - https://gitlab.inria.fr/Damaris/damaris/-/blob/master/LICENSE.txt
* [ ] SPDX is used
* [ ] REUSE is used
